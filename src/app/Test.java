...
public class Test {
	...
	public void testAll() {
		try {
			...
			CompanyFacade company = (CompanyFacade) login.login("or@gmail.com", "123456", ClientType.COMPANY);
			CustomerFacade customer = (CustomerFacade) login.login("aviadgermai1@gmail.com", "6543210",
					ClientType.CUSTOMER);
	 ...
	 */
	private void customersOptionsImproperly(CustomerFacade customer) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void updateCustomerDetailsImproperly(CustomerFacade customerFacade, Customer customer) throws SQLException, InterruptedException {
	 ...
	 * 
	 */
	private void removeCouponPurchaseImproperly(CustomerFacade customer, Coupon coupon) throws SQLException, InterruptedException {
	 ...
	 */
	private void companysOptionsImproperly(CompanyFacade company) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 * @catch {@link CouponsSystemExceptions}
	 */
	private void updateCompanyDetailsImproperly(CompanyFacade companyFacade, Company company) throws SQLException, InterruptedException {
	 ...
	 * @catch {@link CouponsSystemExceptions}
	 */
	private void deleteOneCouponImproperly(CompanyFacade company, Coupon coupon) throws SQLException, InterruptedException {
	 ...
	 *      {@link #createARandomNumber(int, int)}<br>
	 */
	private void updateOneCouponImproperly(CompanyFacade company, Coupon coupon) throws SQLException, InterruptedException {
	 ...
	 */
	private void adminsOptionsImproperly(AdminFacade admin) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void deleteACustomerImproperly(AdminFacade admin, Customer customer) throws SQLException, InterruptedException {
	 ...
	 */
	private void updateACustomerImproperly(AdminFacade admin, Customer customer) throws SQLException, InterruptedException {
	 ...
	 */
	private void getACustomerImproperly(AdminFacade admin) throws SQLException, InterruptedException {
	 ...
	 *      {@link #createALongString(int)}
	 */
	private Customer addACustomerImproperly(AdminFacade admin) throws SQLException, InterruptedException {
	 ...
	 */
	private void deleteACompanyImproperly(AdminFacade admin, Company company) throws SQLException, InterruptedException {
	 ...
	 *      {@link #createALongString(int)}
	 */
	private void updateACompanyImproperly(AdminFacade admin, Company company) throws SQLException, InterruptedException {
	 ...
	 */
	private void getACompanyImproperly(AdminFacade admin) throws SQLException, InterruptedException {
	 ...
	 */
	private void addACompanyImproperly(AdminFacade admin) throws SQLException, InterruptedException {
	...
	/**
	 * This function instantiates a new Company-typed object with semi-random
	 * values.
	 * 
	 * @return the company object manufactured in the function.
	 * @see {@link #createARandomNumber(int, int)}
	 */
	...
	/**
	 * This function instantiates a new Customer-typed object with semi-random
	 * values.
	 * 
	 * @return the customer object manufactured in the function.
	 * @see {@link #createARandomNumber(int, int)}
	 */
	 ...
	 * @see {@link #createARandomNumber(int, int)}
	 */
	private Coupon createNewCoupon(CompanyFacade company) {
		Calendar startDate = Calendar.getInstance();
		Calendar endDate = Calendar.getInstance();
		startDate.add(Calendar.MONTH, 2);
		endDate.add(Calendar.YEAR, createARandomNumber(5, 7));
		return new Coupon(company.getCompanyId(), Category.values()[createARandomNumber(0, 3)],
				"title" + createARandomNumber(100, 500), "description" + createARandomNumber(100, 500), startDate,
				endDate, createARandomNumber(5, 200), createARandomNumber(20, 1000),
				"image" + createARandomNumber(100, 500));
	}
	...
	private Coupon cloneCoupon(Coupon coupon) {
		return new Coupon(coupon.getId(), coupon.getCompanyId(), coupon.getCategory(), coupon.getTitle(),
	 ...
	 * 
	 */
	private void customersOptionsProperly(CustomerFacade customer) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void getCustomerDetails(CustomerFacade customer) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 * 
	 */
	private void getCouponsPurchased(CustomerFacade customer) throws SQLException, CouponsSystemExceptions, InterruptedException {
		System.out.println("Get coupons purchased by category (vacation):");
		for (Coupon coupon : customer.getCustomerCoupons(Category.VACATION)) {
			System.out.println(coupon.toString());
		}
		System.out.println();
		System.out.println("Get coupons purchased by max price (100):");
		for (Coupon coupon : customer.getCustomerCoupons(100)) {
			System.out.println(coupon.toString());
		}
		System.out.println();
	 ...
	 */
	private void removeCouponPurchase(CustomerFacade customer, Coupon coupon)
...
//		coupon = customer.getOneCoupon(coupon.getId());
	 ...
	 */
	private Coupon purchaseACoupon(CustomerFacade customer) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void companysOptionsProperly(CompanyFacade company) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void getCompanyDetails(CompanyFacade company) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void deleteOneCoupon(CompanyFacade company, Coupon coupon) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 * 
	 */
	private void updateOneCoupon(CompanyFacade company, Coupon coupon) throws SQLException, CouponsSystemExceptions, InterruptedException {
		...
		coupon.setPrice(createARandomNumber(100, 500));
	 ...
	 */
	private void getOneCoupon(CompanyFacade company, Coupon coupon) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void getCoupons(CompanyFacade company) throws SQLException, CouponsSystemExceptions, InterruptedException {
		System.out.println("Get coupons by category (electricity):");
		for (Coupon coupon : company.getCouponsByCategory(Category.ELECTRICITY)) {
			System.out.println(coupon.toString());
		}
		System.out.println();
		System.out.println("Get coupons by max price (100):");
		for (Coupon coupon : company.getCouponsByPrice(100)) {
			System.out.println(coupon.toString());
		}
		System.out.println();
		System.out.println("Get all coupons:");
	 ...
	 */
	private Coupon addCoupon(CompanyFacade company) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void adminsOptionsProperly(AdminFacade admin) throws SQLException, CouponsSystemExceptions, InterruptedException {
		System.out.println();
	 ...
	 */
	private void deleteACustomer(AdminFacade admin, Customer customer) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void updateACustomer(AdminFacade admin, Customer customer) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void deleteACompany(AdminFacade admin, Company company) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void updateACompany(AdminFacade admin, Company company) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void getAllCustomers(AdminFacade admin) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void getACustomer(AdminFacade admin, Customer customer) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private Customer addACustomer(AdminFacade admin) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void getAllCompanies(AdminFacade admin) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private void getACompany(AdminFacade admin, Company company) throws SQLException, CouponsSystemExceptions, InterruptedException {
	 ...
	 */
	private Company addACompany(AdminFacade admin) throws SQLException, CouponsSystemExceptions, InterruptedException {
